...
### Key Innovations & Criteria:

*   **The B-Spline Library (`lib_bspline.kcl`):** To capture the subtle, organic "teardrop" of the classic aviator, I implemented a custom **periodic cubic B-Spline library**. This allows for **C2-continuous curves** (mathematically smooth) that lines and arcs cannot achieve. By defining a low-fidelity "control cage," the library generates high-fidelity, automotive-grade surfaces automatically.
...
*   **Parametric Assembly:** The design is fully interactive. The "Master Cage" allows a user to tune the organic lens shape in real-time, with the symmetric 3D rims, glass lenses, and gold-metallic frame updating instantly.
*   **Visual Polish:** Leverages advanced `appearance` properties, including light-blue glass transparency and polished gold metallic finishes.
